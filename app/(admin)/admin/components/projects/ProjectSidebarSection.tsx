...
const ProjectSidebarSection = ({ isSidebarCollapsed }: ProjectSidebarSectionProps) => {
    ...
    <div className="w-full">
      ...
      >
        <div className="flex items-center gap-4">
          <GrProjects className="h-6 w-6 text-gray-700 flex-shrink-0" />
          <span
      ...
      <AnimatePresence>
        {!isSidebarCollapsed && sections.projects && (
          <motion.div

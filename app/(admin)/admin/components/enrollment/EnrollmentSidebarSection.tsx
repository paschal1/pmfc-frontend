...
interface EnrollmentSidebarSectionProps {
  isSidebarCollapsed: boolean
}

const EnrollmentSidebarSection = ({ isSidebarCollapsed }: EnrollmentSidebarSectionProps) => {
  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        title={isSidebarCollapsed ? 'Enrollment' : undefined}
      >
        <div className="flex items-center gap-4">
          <PiStudentDuotone className="h-6 w-6 text-gray-700 flex-shrink-0" />
          <span
      ...
      <AnimatePresence>
        {!isSidebarCollapsed && sections.enrollment && (
          <motion.div

...
interface TrainingSidebarSectionProps {
  isSidebarCollapsed: boolean
}

const TrainingSidebarSection = ({ isSidebarCollapsed }: TrainingSidebarSectionProps) => {
  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        title={isSidebarCollapsed ? 'Training' : undefined}
      >
      ...
      <AnimatePresence>
        {!isSidebarCollapsed && sections.training && (
          <motion.div
